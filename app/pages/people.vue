...
.people-explorer__map { position: absolute; inset: 0 460px 0 0; }
...
.people-panel { position: absolute; z-index: 3; width: 460px; inset: 0 0 0 auto; display: flex; flex-direction: column; border-left: 1px solid #ffffff0d; background: var(--color-neutral-950); overflow: hidden; }
.people-panel__header { padding: 20px 16px 14px; border-bottom: 1px solid #ffffff0d; }
...
.people-panel__list { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 0; padding: 4px 8px; }
...
.people-panel__footer { border-top: 1px solid #ffffff0d; padding: 4px 16px 8px; }
...
@media (min-width: 1600px) { .people-panel { width: 500px; } .people-explorer__map { right: 500px; } }
...
@media (max-width: 767px) {
  ...
  .people-panel { inset: auto 0 0; width: 100%; height: 43%; border-radius: 0; border-left: 0; border-top: 1px solid #ffffff16; background: var(--color-neutral-950); }
